            ...
            <div class="ibox-content">
                <form class="form-horizontal" id="form" onsubmit="return false">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input id="cas" value="${realDetail.casNo}" type="text" class="form-control" required>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input id="en_name" value="${realDetail.englishName}" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input id="cn_name" value="${realDetail.chineseName}" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">初始图片</label>
                        <div class="col-sm-7">
                           <img class="origin" src = "${realDetail.image}" style="width: 60px; height: 60px">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input id="purity" value="${realDetail.purity}" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                           <span class="col-sm-8">
                            <input id="amount" value="${realDetail.buyAmountWithoutUnit}" type="text" class="form-control" style="height:30px">
                           </span>
                            <span class="col-sm-4">
                            <select class="weight">
                                <option>g</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-4" style="position:relative;left: 20px">
                            <input value="${realDetail.prices[0]}" id="lowPrice" type="text" class="input-sm form-control" name="lowPrice">
                            <span class="input-group-addon">-</span>
                            <input value="${realDetail.prices[1]}" id="highPrice" type="text" class="input-sm form-control" name="highPrice">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-4" style="position:relative;left: 20px">
                            <input value="${realDetail.deadlines[0]}" id="beginWeek" type="text" class="input-sm form-control" name="lowPrice">
                            <span class="input-group-addon">-</span>
                            <input value="${realDetail.deadlines[1]}" id="endWeek" type="text" class="input-sm form-control" name="highPrice">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            <c:set var = "item1_checked" value="${realDetail.guaranteeMoneyPercent != null}"/>
                                            <c:set var = "item2_checked" value="${realDetail.rewardMoneyPercent != null}"/>
                                            <p><input checked="${item1_checked}" id="item1" type="checkbox">可付订单价<input id="content1" type="text" style="width: 60px" value="${realDetail.guaranteeMoneyPercent}">%至网站作保证金(默认0.5%)</p>
                                            <p><input checked="${item2_checked}" id="item2" type="checkbox">提前交货可奖励订单价<input id="content2" type="text" style="width: 60px" value="${realDetail.guaranteeMoneyPercent}">%/天(默认0.5)</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea id="remark" class="form-control" style="height:120px">${realDetail.remark}</textarea>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
...
<script>
    ...
    $("#form").validate({
        submitHandler:function(form){
            ...
            $.ajaxFileUpload({
                url: '/real/republishRealOrder', //用于文件上传的服务器端请求地址
                ...
                data:{
                    ...
                    image: $("#previewImg").val() == "" ? null : $("#previewImg").val(),
                    purity: $("#purity").val(),
                    diagramRequire:$(".diagram").val().join(','),
                    makeBill: $(".bill").val(),
                    endTime:$("#days").val(),
