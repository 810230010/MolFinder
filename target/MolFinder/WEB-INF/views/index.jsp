...
<div class="menus" style="font-size: 24px;font-weight: 600;margin-bottom: 140px">
    <div class="row1">
        ...
        <div class="col-md-4 text-left"><a class="authority" href="#">原料采购</a></div>
    </div>

    <div class="row2" style="margin-top: 40px">
        <div class="col-md-4 text-right"><a class="authority" url="/real/realPublishPage">发布实单</a></div>
        <div class="col-md-4 text-center"><a class="authority" href="" url="/enquiry/enquiryPublishPage">发布询单</a></div>
        <div class="col-md-4 text-left"><a class="authority" href="">原料供应</a></div>
    </div>
</div>
