                ...
                <form class="form-horizontal" id="form" onsubmit="return false">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-6" style="position:relative;left:-20px">
                                <div class="input-group col-sm-8" style="position:relative;left: 20px">
                                    <input type="text" class="input-sm form-control col-sm-6" value="${queryCallpriceDetail.callPriceMoney}" readonly>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-4" style="position:relative;left: 20px">
                            ...
                            <input id="beginWeek" type="text" class="input-sm form-control" readonly value="${queryCallpriceDetail.callSubmitDeadline}">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select class="col-sm-12 bill" disabled>
                                <option>${queryCallpriceDetail.makeBill}</option>
                            </select>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                            ...
                            <div class="panel-group" id="accordion">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <p>可付订单价<input id="content1" type="text" style="width: 60px" value="${queryCallpriceDetail.prepayedMoneyAmount}" readonly>%至网站作保证金(默认0.5%)</p>
                                        <p>接受违约金过期<input id="content2" type="text" style="width: 60px" value="${queryCallpriceDetail.vilationMoneyAmount}" readonly>%/天(默认1%)</p>
                                    </div>
                                </div>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea id="remark" class="form-control" style="height:120px" readonly>${queryCallpriceDetail.otherRequire}</textarea>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <div class="text-center">
                            <button onclick="jump2makeOrder()" class="btn btn-primary">生成订单</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function jump2makeOrder() {
        window.location.href = "/order/queryMakeOrderPage?queryCallId=" + ${queryCallpriceDetail.queryCallId} + "&queryOrderId=" + ${queryCallpriceDetail.queryOrderId};
    }
