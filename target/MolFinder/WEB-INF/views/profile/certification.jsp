...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal" id="form">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="qq">身份证号码:</label>
                            <div class="col-sm-6">
                    ...
                    <c:if test="${certification.isPass == 'CHECKING' or certification.isPass == 'PASS' or certification.isPass == 'NOTPASS'}">
                        <form class="form-horizontal" id="form">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">认证类型</label>
                                <div class="col-sm-6">
                                    <input type="text" value="${certification.certificateType1}" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="companyName">所在企业:</label>
                                <div class="col-sm-6">
                                    <input name="name" type="text" class="form-control" readonly value="${certification.companyName}" required/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="username">用户名:</label>
                                <div class="col-sm-6">
                                    <input name="username" class="form-control" value="${certification.username}" type="text" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="phone">手机号:</label>
                                <div class="col-sm-6">
                                    <input  name="sort" class="form-control" value="${certification.phone}" type="text" readonly/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="realname">真实姓名:</label>
                                <div class="col-sm-6">
                                    <input name="realname" value="${certification.realname}" type="text" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="qq">身份证号码:</label>
                                <div class="col-sm-6">
                                    <input  name="qq" type="text" value="${certification.IDNumber}" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <c:forEach items="${certification.images}" var="item">
                                        <img src="${item}" class="col-sm-2" alt="">
                                    </c:forEach>
                                </div>
                            </div>
                            <c:if test="${certification.isPass == 'NOTPASS'}">
                                <div class="hr-line-dashed"></div>
                                <button id="recertificate-btn" type="button" class="btn btn-primary col-sm-4 col-sm-offset-2">重新填写认证</button>
                            </c:if>
                        </form>
                    </c:if>
            ...
            <c:if test="${certification.isPass == 'CHECKING'}">
                <img src="/static/img/check.jpg" alt="" style="height:300px; width: 300px;z-index: 1000;border-radius: 50%;position: absolute;top:200px;left:30%" >
            </c:if>
            <c:if test="${certification.isPass == 'PASS'}">
                <img src="/static/img/pass.jpg" alt="" style="height:300px; width: 300px;z-index: 1000;border-radius: 50%;position: absolute;top:200px;left:30%" >
            </c:if>
            <c:if test="${certification.isPass == 'NOTPASS'}">
                <img src="/static/img/notpass.jpg" alt="" style="height:300px; width: 300px;z-index: 1000;border-radius: 50%;position: absolute;top:200px;left:30%" >
            </c:if>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#recertificate-btn").click(function () {
        $.ajax({
            url: "/profile/recertificate",
            data: {
