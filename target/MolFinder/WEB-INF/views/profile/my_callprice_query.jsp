...
<div style="padding-top: 30px;">
    <div style="border-left: 5px solid #c23;height:44px;line-height:44px;padding-left:10px;box-shadow: grey">
        <font style="font-size: 24px"><b>我报价的询单</b></font>
    </div>
...
<script>
    ...
    function fun1(){
        $('#dataTable').DataTable({
            "ajax": {
                'url': '/profile/myaccept/queryOrders/' + 'BIDDING',
                "data": function(d) {
                    var param = {};
            ...
            "columns": [
                ...
                {"data":"casNo","width": "10%","title":"积分奖励","orderable": false},
                {
                    ...
                    "render": function (data, type, row) {
                        return [
                            '<a class="table-button btn btn-primary btn-xs block table-action update" href="javascript:void(0)">',
    ...
    function fun2(){
        $('#dataTable').DataTable({
            "ajax": {
                'url': '/profile/myaccept/queryOrders/' + 'SENDING',
                "data": function(d) {
                    var param = {};
                    param.page = d.start/d.length + 1;
                    param.pageSize = d.length;
    ...
    function fun3(){
        $('#dataTable').DataTable({
            "ajax": {
                'url': '/profile/myaccept/queryOrders/' + 'SENDED',
                "data": function(d) {
                    var param = {};
                    param.page = d.start/d.length + 1;
                    param.pageSize = d.length;
    ...
    function fun4(){
        $('#dataTable').DataTable({
            "ajax": {
                'url': '/profile/myaccept/queryOrders/' + 'CANCEL',
                "data": function(d) {
                    var param = {};
                    param.page = d.start/d.length + 1;
                    param.pageSize = d.length;
